  ...
  function Endless(method, count_on_page) {
    ...
    this.getPage = function (page) {
      return API.post(method, {page: page})
        .then(function (data) {
          var i = data.result.images.length;
          while (i--){
     ...
     /* //TODO вернуть API
      ...
      $TEST.resolve();
        ...
        .done(function (response) {
          var list = [response.count_on_page * (page - 1), 0].concat(response.images);
